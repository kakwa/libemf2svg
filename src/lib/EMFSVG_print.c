...
*/
    ...
    /* **********************************************************************************************
       ...
       The exceptions:
       void core3_print(const char *name, const char *label, const char *contents, drawingStates *states)
       void core7_print(const char *name, const char *field1, const char *field2, const char *contents, drawingStates *states)
       void core8_print(const char *name, const char *contents, drawingStates *states, int type)
    ...
    void core1_print(const char *name, const char *contents, drawingStates *states){
        unsigned int i;
        UNUSED(name);
    ...
    void core2_print(const char *name, const char *contents, drawingStates *states){
        unsigned int i;
        UNUSED(name);
    ...
    void core10_print(const char *name, const char *contents, drawingStates *states){
        UNUSED(name);
        unsigned int i;
    ...
    void core12_print(const char *name, const char *contents, drawingStates *states){
        UNUSED(name);
    ...
    void core13_print(const char *name, const char *contents, drawingStates *states){
        UNUSED(name);
    ...
    /**
      ...
      */
    void U_EMRNOTIMPLEMENTED_print(const char *name, const char *contents, drawingStates *states){
        UNUSED(name);
        UNUSED(contents);
