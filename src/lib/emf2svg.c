...
void U_EMRSETWINDOWORGEX_draw(const char *contents, FILE *out,
    ...
    states->offsetX =
        -1 * (double)pEmr->ptlOrigin.x * states->scalingX + states->offsetX;
    states->offsetY =
        -1 * (double)pEmr->ptlOrigin.y * states->scalingY + states->offsetY;
}
...
#define U_EMRUNDEF69_draw(A)                                                   \
    U_EMRNOTIMPLEMENTED_draw("U_EMRUNDEF69", A) //!< Not implemented.
...
#define U_EMRPOLYTEXTOUTA_draw(A)                                              \
    U_EMRNOTIMPLEMENTED_draw("U_EMRPOLYTEXTOUTA", A) //!< Not implemented.
// U_EMRPOLYTEXTOUTW         97 NOT IMPLEMENTED, denigrated after Windows NT
#define U_EMRPOLYTEXTOUTW_draw(A)                                              \
    U_EMRNOTIMPLEMENTED_draw("U_EMRPOLYTEXTOUTW", A) //!< Not implemented.
...
#define U_EMRGLSRECORD_draw(A)                                                 \
    U_EMRNOTIMPLEMENTED_draw("U_EMRGLSRECORD", A) //!< Not implemented.
// U_EMRGLSBOUNDEDRECORD    103  Not implemented
#define U_EMRGLSBOUNDEDRECORD_draw(A)                                          \
    U_EMRNOTIMPLEMENTED_draw("U_EMRGLSBOUNDEDRECORD", A) //!< Not implemented.
...
#define U_EMRDRAWESCAPE_draw(A)                                                \
    U_EMRNOTIMPLEMENTED_draw("U_EMRDRAWESCAPE", A) //!< Not implemented.
// U_EMREXTESCAPE           106  Not implemented
#define U_EMREXTESCAPE_draw(A)                                                 \
    U_EMRNOTIMPLEMENTED_draw("U_EMREXTESCAPE", A) //!< Not implemented.
// U_EMRUNDEF107            107  Not implemented
#define U_EMRUNDEF107_draw(A)                                                  \
    U_EMRNOTIMPLEMENTED_draw("U_EMRUNDEF107", A) //!< Not implemented.
...
#define U_EMRFORCEUFIMAPPING_draw(A)                                           \
    U_EMRNOTIMPLEMENTED_draw("U_EMRFORCEUFIMAPPING", A) //!< Not implemented.
// U_EMRNAMEDESCAPE         110  Not implemented
#define U_EMRNAMEDESCAPE_draw(A)                                               \
    U_EMRNOTIMPLEMENTED_draw("U_EMRNAMEDESCAPE", A) //!< Not implemented.
// U_EMRCOLORCORRECTPALETTE 111  Not implemented
#define U_EMRCOLORCORRECTPALETTE_draw(A)                                       \
    U_EMRNOTIMPLEMENTED_draw("U_EMRCOLORCORRECTPALETTE",                       \
                             A) //!< Not implemented.
// U_EMRSETICMPROFILEA      112  Not implemented
#define U_EMRSETICMPROFILEA_draw(A)                                            \
    U_EMRNOTIMPLEMENTED_draw("U_EMRSETICMPROFILEA", A) //!< Not implemented.
// U_EMRSETICMPROFILEW      113  Not implemented
#define U_EMRSETICMPROFILEW_draw(A)                                            \
    U_EMRNOTIMPLEMENTED_draw("U_EMRSETICMPROFILEW", A) //!< Not implemented.
...
#define U_EMRUNDEF117_draw(A)                                                  \
    U_EMRNOTIMPLEMENTED_draw("U_EMRUNDEF117", A) //!< Not implemented.
...
#define U_EMRSETLINKEDUFIS_draw(A)                                             \
    U_EMRNOTIMPLEMENTED_draw("U_EMR_SETLINKEDUFIS", A) //!< Not implemented.
// U_EMRSETTEXTJUSTIFICATION120  Not implemented (denigrated)
#define U_EMRSETTEXTJUSTIFICATION_draw(A)                                      \
    U_EMRNOTIMPLEMENTED_draw("U_EMR_SETTEXTJUSTIFICATION",                     \
                             A) //!< Not implemented.
// U_EMRCOLORMATCHTOTARGETW 121  Not implemented
#define U_EMRCOLORMATCHTOTARGETW_draw(A)                                       \
    U_EMRNOTIMPLEMENTED_draw("U_EMR_COLORMATCHTOTARGETW",                      \
                             A) //!< Not implemented.
