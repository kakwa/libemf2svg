...
void U_PMF_VARPOINTS_print(const char **contents, int Flags, uint32_t Elements,
    ...
    for (Xpos = Ypos = i = 0; i < Elements; i++) {
        printf(" %d:", i);
        if (Flags & U_PPF_P) {
            (void)U_PMF_POINTR_print(contents, &Xpos, &Ypos, blimit);
        } else if (Flags & U_PPF_C) {
            (void)U_PMF_POINT_print(contents, blimit);
        } else {
            (void)U_PMF_POINTF_print(contents, blimit);
        }
    }
#if 0
int residual;
...
/**
   ...
   record
    ...
    \param off        Offset from the beginning of the EMF+ file to the start of
   this record.
*/
int U_pmf_onerec_print(const char *contents, const char *blimit, int recnum,
    ...
    */
    ...
    if (Header.Size < sizeof(U_PMF_CMN_HDR) ||
        IS_MEM_UNSAFE(contents, Header.Size, blimit))
        return (-1);

    switch (type) {
    case (U_PMR_HEADER):
        rstatus = U_PMR_HEADER_print(contents);
        break;
    case (U_PMR_ENDOFFILE):
        rstatus = U_PMR_ENDOFFILE_print(contents);
        U_OA_release(&ObjCont);
        break;
    case (U_PMR_COMMENT):
        rstatus = U_PMR_COMMENT_print(contents);
        break;
    case (U_PMR_GETDC):
        rstatus = U_PMR_GETDC_print(contents);
        break;
    case (U_PMR_MULTIFORMATSTART):
        rstatus = U_PMR_MULTIFORMATSTART_print(contents);
        break;
    case (U_PMR_MULTIFORMATSECTION):
        rstatus = U_PMR_MULTIFORMATSECTION_print(contents);
        break;
    case (U_PMR_MULTIFORMATEND):
        rstatus = U_PMR_MULTIFORMATEND_print(contents);
        break;
    case (U_PMR_OBJECT):
        rstatus = U_PMR_OBJECT_print(contents, blimit, &ObjCont, 0);
        break;
    case (U_PMR_CLEAR):
        rstatus = U_PMR_CLEAR_print(contents);
        break;
    case (U_PMR_FILLRECTS):
        rstatus = U_PMR_FILLRECTS_print(contents);
        break;
    case (U_PMR_DRAWRECTS):
        rstatus = U_PMR_DRAWRECTS_print(contents);
        break;
    case (U_PMR_FILLPOLYGON):
        rstatus = U_PMR_FILLPOLYGON_print(contents);
        break;
    case (U_PMR_DRAWLINES):
        rstatus = U_PMR_DRAWLINES_print(contents);
        break;
    case (U_PMR_FILLELLIPSE):
        rstatus = U_PMR_FILLELLIPSE_print(contents);
        break;
    case (U_PMR_DRAWELLIPSE):
        rstatus = U_PMR_DRAWELLIPSE_print(contents);
        break;
    case (U_PMR_FILLPIE):
        rstatus = U_PMR_FILLPIE_print(contents);
        break;
    case (U_PMR_DRAWPIE):
        rstatus = U_PMR_DRAWPIE_print(contents);
        break;
    case (U_PMR_DRAWARC):
        rstatus = U_PMR_DRAWARC_print(contents);
        break;
    case (U_PMR_FILLREGION):
        rstatus = U_PMR_FILLREGION_print(contents);
        break;
    case (U_PMR_FILLPATH):
        rstatus = U_PMR_FILLPATH_print(contents);
        break;
    case (U_PMR_DRAWPATH):
        rstatus = U_PMR_DRAWPATH_print(contents);
        break;
    case (U_PMR_FILLCLOSEDCURVE):
        rstatus = U_PMR_FILLCLOSEDCURVE_print(contents);
        break;
    case (U_PMR_DRAWCLOSEDCURVE):
        rstatus = U_PMR_DRAWCLOSEDCURVE_print(contents);
        break;
    case (U_PMR_DRAWCURVE):
        rstatus = U_PMR_DRAWCURVE_print(contents);
        break;
    case (U_PMR_DRAWBEZIERS):
        rstatus = U_PMR_DRAWBEZIERS_print(contents);
        break;
    case (U_PMR_DRAWIMAGE):
        rstatus = U_PMR_DRAWIMAGE_print(contents);
        break;
    case (U_PMR_DRAWIMAGEPOINTS):
        rstatus = U_PMR_DRAWIMAGEPOINTS_print(contents);
        break;
    case (U_PMR_DRAWSTRING):
        rstatus = U_PMR_DRAWSTRING_print(contents);
        break;
    case (U_PMR_SETRENDERINGORIGIN):
        rstatus = U_PMR_SETRENDERINGORIGIN_print(contents);
        break;
    case (U_PMR_SETANTIALIASMODE):
        rstatus = U_PMR_SETANTIALIASMODE_print(contents);
        break;
    case (U_PMR_SETTEXTRENDERINGHINT):
        rstatus = U_PMR_SETTEXTRENDERINGHINT_print(contents);
        break;
    case (U_PMR_SETTEXTCONTRAST):
        rstatus = U_PMR_SETTEXTCONTRAST_print(contents);
        break;
    case (U_PMR_SETINTERPOLATIONMODE):
        rstatus = U_PMR_SETINTERPOLATIONMODE_print(contents);
        break;
    case (U_PMR_SETPIXELOFFSETMODE):
        rstatus = U_PMR_SETPIXELOFFSETMODE_print(contents);
        break;
    case (U_PMR_SETCOMPOSITINGMODE):
        rstatus = U_PMR_SETCOMPOSITINGMODE_print(contents);
        break;
    case (U_PMR_SETCOMPOSITINGQUALITY):
        rstatus = U_PMR_SETCOMPOSITINGQUALITY_print(contents);
        break;
    case (U_PMR_SAVE):
        rstatus = U_PMR_SAVE_print(contents);
        break;
    case (U_PMR_RESTORE):
        rstatus = U_PMR_RESTORE_print(contents);
        break;
    case (U_PMR_BEGINCONTAINER):
        rstatus = U_PMR_BEGINCONTAINER_print(contents);
        break;
    case (U_PMR_BEGINCONTAINERNOPARAMS):
        rstatus = U_PMR_BEGINCONTAINERNOPARAMS_print(contents);
        break;
    case (U_PMR_ENDCONTAINER):
        rstatus = U_PMR_ENDCONTAINER_print(contents);
        break;
    case (U_PMR_SETWORLDTRANSFORM):
        rstatus = U_PMR_SETWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_RESETWORLDTRANSFORM):
        rstatus = U_PMR_RESETWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_MULTIPLYWORLDTRANSFORM):
        rstatus = U_PMR_MULTIPLYWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_TRANSLATEWORLDTRANSFORM):
        rstatus = U_PMR_TRANSLATEWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_SCALEWORLDTRANSFORM):
        rstatus = U_PMR_SCALEWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_ROTATEWORLDTRANSFORM):
        rstatus = U_PMR_ROTATEWORLDTRANSFORM_print(contents);
        break;
    case (U_PMR_SETPAGETRANSFORM):
        rstatus = U_PMR_SETPAGETRANSFORM_print(contents);
        break;
    case (U_PMR_RESETCLIP):
        rstatus = U_PMR_RESETCLIP_print(contents);
        break;
    case (U_PMR_SETCLIPRECT):
        rstatus = U_PMR_SETCLIPRECT_print(contents);
        break;
    case (U_PMR_SETCLIPPATH):
        rstatus = U_PMR_SETCLIPPATH_print(contents);
        break;
    case (U_PMR_SETCLIPREGION):
        rstatus = U_PMR_SETCLIPREGION_print(contents);
        break;
    case (U_PMR_OFFSETCLIP):
        rstatus = U_PMR_OFFSETCLIP_print(contents);
        break;
    case (U_PMR_DRAWDRIVERSTRING):
        rstatus = U_PMR_DRAWDRIVERSTRING_print(contents);
        break;
    case (U_PMR_STROKEFILLPATH):
        rstatus = U_PMR_STROKEFILLPATH_print(contents);
        break;
    case (U_PMR_SERIALIZABLEOBJECT):
        rstatus = U_PMR_SERIALIZABLEOBJECT_print(contents);
        break;
    case (U_PMR_SETTSGRAPHICS):
        rstatus = U_PMR_SETTSGRAPHICS_print(contents);
        break;
    case (U_PMR_SETTSCLIP):
        rstatus = U_PMR_SETTSCLIP_print(contents);
        break;
    }
    if (!rstatus)
        status = -1;
...
int U_PMF_CMN_HDR_print(const char *contents, U_PMF_CMN_HDR Header, int precnum,
                        int off) {
    printf("   %-29srec+:%5d type:%X offset:%8d rsize:%8u dsize:%8u "
           "flags:%4.4X crc32:%8.8X\n",
           U_pmr_names(Header.Type & U_PMR_TYPE_MASK), precnum, Header.Type,
           off, Header.Size, Header.DataSize, Header.Flags,
...
int U_PMF_HATCHSTYLEENUMERATION_print(int hstype) {
    ...
    case U_HSP_DiagonalBrick:
        printf("DiagonalBrick");
        break;
    case U_HSP_HorizontalBrick:
        printf("HorizontalBrick");
        break;
    case U_HSP_Weave:
        printf("Weave");
        break;
    ...
    case U_HSP_SmallCheckerBoard:
        printf("SmallCheckerBoard");
        break;
    case U_HSP_LargeCheckerBoard:
        printf("LargeCheckerBoard");
        break;
    case U_HSP_OutlinedDiamond:
        printf("OutlinedDiamond");
        break;
...
int U_PMF_OBJECTTYPEENUMERATION_print(int otype) {
    ...
    case U_OT_ImageAttributes:
        printf("ImageAttributes");
        break;
    case U_OT_CustomLineCap:
        printf("CustomLineCap");
        break;
    default:
        status = 0;
        printf("INVALID(%d)", otype);
...
int U_PMF_PX_FMT_ENUM_print(int pfe) {
    ...
    case 0:
        ...
        break;
    case 1:
        printf("monochrome with LUT");
        break;
    case 2:
        printf("4 bit with LUT");
        break;
    case 3:
        printf("8 bit with LUT");
        break;
    case 4:
        printf("16 bits grey values");
        break;
    case 5:
        printf("16 bit RGB values (5,5,5,(1 ignored))");
        break;
    case 6:
        printf("16 bit RGB values (5,6,5)");
        break;
    case 7:
        printf("16 bit ARGB values (1 alpha, 5,5,5 colors)");
        break;
    case 8:
        printf("24 bit RGB values (8,8.8)");
        break;
    case 9:
        printf("32 bit RGB value  (8,8,8,(8 ignored))");
        break;
    case 10:
        printf("32 bit ARGB values (8 alpha,8,8,8)");
        break;
    case 11:
        printf(
        ...
        break;
    case 12:
        printf("48 bit RGB (16,16,16)");
        break;
    case 13:
        printf("64 bit ARGB (16 alpha, 16,16,16)");
        break;
    case 14:
        printf("64 bit PARGB (16,16,16,16, but RGB already multiplied by A)");
        break;
    default:
        printf("INVALID(%d)", idx);
        break;
    }
    printf(")");
    return (1);
...
int U_PMF_STRINGFORMAT_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        ...
        printf(" Language");
        (void)U_PMF_LANGUAGEIDENTIFIER_print(Sfs.Language);
        ...
        printf(" DigitLanguage");
        (void)U_PMF_LANGUAGEIDENTIFIER_print(Sfs.DigitLanguage);
...
int U_PMF_BITMAP_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        ...
        switch (Bs.Type) {
        case 0:
            printf(" Type:MSBitmap\n");
            break;
        case 1:
            printf(" Type:(PNG|JPG|GIF|EXIF|TIFF)\n");
            break;
        default:
...
int U_PMF_BLENDFACTORS_print(const char *contents, const char *type,
    ...
    int status = U_PMF_BLENDFACTORS_get(contents, &Elements, &Positions,
                                        &Factors, blimit);
    if (status) {
        printf("   +  BlendFactors%s: Entries:%d (entry,pos,factor): ", type,
               Elements);
        for (i = 0; i < Elements; i++) {
...
int U_PMF_CUSTOMLINECAPARROWDATA_print(const char *contents,
    ...
    if (status) {
        ...
        printf(" FillHotSpot:{%f,%f}", Ccad.FillHotSpot[0],
               Ccad.FillHotSpot[1]);
        printf(" LineHotSpot:{%f,%f}", Ccad.LineHotSpot[0],
               Ccad.LineHotSpot[1]);
        printf("\n");
    }
    return (status);
...
int U_PMF_CUSTOMLINECAPDATA_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        ...
        printf(" FillHotSpot:{%f,%f}", Clcd.FillHotSpot[0],
               Clcd.FillHotSpot[1]);
...
int U_PMF_CUSTOMLINECAPOPTIONALDATA_print(const char *contents, uint32_t Flags,
    ...
    if (status) { /* True even if there is nothing in it! */
        ...
        if (FillData || LineData) {
            if (FillData) {
                (void)U_PMF_FILLPATHOBJ_print(FillData, blimit);
            }
            if (LineData) {
                (void)U_PMF_LINEPATH_print(LineData, blimit);
            }
        } else {
            printf("None");
        }
...
int U_PMF_FOCUSSCALEDATA_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        printf(" FocusScaleData: Count:%d ScaleX:%f ScaleY:%f ", Count, ScaleX,
               ScaleY);
    }
    return (status);
}
...
int U_PMF_LINEARGRADIENTBRUSHDATA_print(const char *contents,
    ...
    if (status) {
        printf("   +  LinearGradientBrushData: Flags:%X WrapMode:%d Rect:",
...
int U_PMF_PATHPOINTTYPERLE_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        status = Elements;
        printf(" PathPointTypeRLE: Bezier:%c Elements:%u, Type: ",
               (Bezier ? 'Y' : 'N'), Elements);
        (void)U_PMF_PATHPOINTTYPE_ENUM_print(Type);
        printf("\n");
    }
...
int U_PMF_PENDATA_print(const char *contents, const char *blimit) {
    ...
    if (status) {
        ...
        (void)U_PMF_PENOPTIONALDATA_print(
            Data, Flags, blimit); /* prints a new line at end */
    }
    return (status);
}
...
/**
    ...
    \param  contents   Record from which to print data
    \param  blimit     one byte past the end of data
    \param  Flags      PenData Flags that determine which optionaldata fields
...
int U_PMF_PENOPTIONALDATA_print(const char *contents, int Flags,
    ...
    if (status) {
        ...
        if (Flags & U_PD_StartCap) {
            printf(" StartCap:%d", StartCap);
        }
        if (Flags & U_PD_EndCap) {
            printf(" EndCap:%d", EndCap);
        }
        if (Flags & U_PD_Join) {
            printf(" Join:%X", Join);
        }
        if (Flags & U_PD_MiterLimit) {
            printf(" MiterLimit:%f", MiterLimit);
        }
        if (Flags & U_PD_LineStyle) {
            printf(" Style:%X", Style);
        }
        if (Flags & U_PD_DLCap) {
            printf(" DLCap:%X", DLCap);
        }
        if (Flags & U_PD_DLOffset) {
            printf(" DLOffset:%f", DLOffset);
        }
        if (Flags & U_PD_DLData) {
            (void)U_PMF_DASHEDLINEDATA_print(DLData, blimit);
        }
        ...
        if (Flags & U_PD_CLData) {
            (void)U_PMF_COMPOUNDLINEDATA_print(CmpndLineData, blimit);
        }
        if (Flags & U_PD_CustomStartCap) {
            (void)U_PMF_CUSTOMSTARTCAPDATA_print(CSCapData, blimit);
        }
        if (Flags & U_PD_CustomEndCap) {
            (void)U_PMF_CUSTOMENDCAPDATA_print(CECapData, blimit);
        }
    }
    return (status);
}
...
int U_PMF_RECT_S_print(U_PMF_RECT *Rect) {
    printf("{UL{%d,%d},WH{%d,%d}}", Rect->X, Rect->Y, Rect->Width,
           Rect->Height);
    return (1);
}
...
int U_PMF_RECTF_S_print(U_PMF_RECTF *Rect) {
    printf("{UL{%f,%f},WH{%f,%f}}", Rect->X, Rect->Y, Rect->Width,
           Rect->Height);
    return (1);
}
...
int U_PMF_STRINGFORMATDATA_print(const char *contents, uint32_t TabStopCount,
    ...
    if (status) {
        ...
        for (; RangeCount; RangeCount--, CharRange++) {
            printf(" {%d,%d}", CharRange->First, CharRange->Length);
        }
        printf("\n");
    }
    return (status);
...
int U_PMF_TRANSFORMMATRIX2_print(U_PMF_TRANSFORMMATRIX *Tm) {
    if (Tm) {
        printf(" Matrix:{%f,%f,%f,%f,%f,%f}", Tm->m11, Tm->m12, Tm->m21,
               Tm->m22, Tm->dX, Tm->dY);
    } else {
        printf(" Matrix:(None)");
    }
...
int U_PMR_DRAWARC_print(const char *contents) {
    ...
    int status = U_PMR_DRAWARC_get(contents, NULL, &PenID, &ctype, &Start,
                                   &Sweep, &Rect);
    if (status) {
        printf("   +  PenID:%u ctype:%d Start:%f Sweep:%f Rect:", PenID, ctype,
               Start, Sweep);
...
int U_PMR_DRAWCURVE_print(const char *contents) {
    ...
    if (status) {
        printf("   +  PenID:%u ctype:%d Tension:%f Offset:%u NSegs:%u "
               "Elements:%u\n",
...
int U_PMR_DRAWIMAGE_print(const char *contents) {
    ...
    if (status) {
        printf("   +  ImgID:%u ctype:%d ImgAttrID:%u SrcUnit:%d SrcRect:",
               ImgID, ctype, ImgAttrID, SrcUnit);
...
int U_PMR_DRAWIMAGEPOINTS_print(const char *contents) {
    ...
    if (status) {
        printf("   +  ImgID:%u ctype:%d etype:%d ImgAttrID:%u SrcUnit:%d "
               "Elements:%u SrcRect:",
...
int U_PMR_DRAWRECTS_print(const char *contents) {
    ...
    if (status) {
        printf("   +  PenID:%u ctype:%d Elements:%u Rect:", PenID, ctype,
               Elements);
...
int U_PMR_DRAWSTRING_print(const char *contents) {
    ...
    if (status) {
        printf("   +  FontID:%u StringFormatID:%u btype:%d Length:%u Rect:",
...
int U_PMR_FILLCLOSEDCURVE_print(const char *contents) {
    ...
    int status = U_PMR_FILLCLOSEDCURVE_get(contents, NULL, &btype, &ctype,
                                           ...
                                           &Elements, &Points);
    if (status) {
        printf("   +  btype:%d ctype:%d ftype:%d RelAbs:%d Elements:%u", btype,
               ctype, ftype, RelAbs, Elements);
        (void)U_PMF_VARBRUSHID_print(btype, BrushID);
        printf("\n");
        U_PMF_VARPOINTF_S_print(Points, Elements);
        free(Points);
...
int U_PMR_FILLPOLYGON_print(const char *contents) {
    ...
    if (status) {
        printf("   +  btype:%d ctype:%d RelAbs:%d Elements:%u", btype, ctype,
               RelAbs, Elements);
        (void)U_PMF_VARBRUSHID_print(btype, BrushID);
        printf("\n");
        U_PMF_VARPOINTF_S_print(Points, Elements);
...
/**
   ...
   continuation records is encountered.
    ...
    This is the ONLY EMF+ record type which needs an explicit blimit passed in.
   Since it glues
      together multiple records, and calls itself recursively, the initial
...
int U_PMR_OBJECT_print(const char *contents, const char *blimit,
    ...
    */
    ...
    if (term) { /* mode for handling unexpected end of accumulated object */
        ...
        printf("   +  START Forced Termination of Accumulating object Bytes:%u "
               "ObjID:%u DeclaredType:%d(",
    ...
    if (status) {
        ...
        switch (ttype) {
        case U_OT_Brush:
            (void)U_PMF_BRUSH_print(ObjCont->accum, blimit);
            break;
        case U_OT_Pen:
            (void)U_PMF_PEN_print(ObjCont->accum, blimit);
            break;
        case U_OT_Path:
            (void)U_PMF_PATH_print(ObjCont->accum, blimit);
            break;
        case U_OT_Region:
            (void)U_PMF_REGION_print(ObjCont->accum, blimit);
            break;
        case U_OT_Image:
            (void)U_PMF_IMAGE_print(ObjCont->accum, blimit);
            break;
        case U_OT_Font:
            (void)U_PMF_FONT_print(ObjCont->accum, blimit);
            break;
        case U_OT_StringFormat:
            (void)U_PMF_STRINGFORMAT_print(ObjCont->accum, blimit);
            break;
        case U_OT_ImageAttributes:
            (void)U_PMF_IMAGEATTRIBUTES_print(ObjCont->accum, blimit);
            break;
        case U_OT_CustomLineCap:
            (void)U_PMF_CUSTOMLINECAP_print(ObjCont->accum, "", blimit);
            break;
        case U_OT_Invalid:
        default:
    ...
    if (term)
        printf("   +  END   Forced Termination of Accumulating object\n");
    return (status);
}
...
int U_PMR_MULTIPLYWORLDTRANSFORM_print(const char *contents) {
    ...
    if (status) {
        printf("   +  xmtype:%d Multiply:%s", xmtype,
               (xmtype ? "Post" : "Pre"));
        U_PMF_TRANSFORMMATRIX2_print(&Matrix);
        printf("\n");
    } else {
