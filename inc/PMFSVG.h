...
#include "upmf.h" /* includes uemf.h */
    ...
    int U_PMF_TRANSFORMMATRIX2_draw(U_PMF_TRANSFORMMATRIX *Matrix, FILE *out, drawingStates *states);
    int U_PMF_ROTMATRIX2_draw(U_PMF_ROTMATRIX *Matrix, FILE *out, drawingStates *states);
    ...
    int U_PMR_STROKEFILLPATH_draw(const char *contents, FILE *out, drawingStates *states);      /* not documented */
    int U_PMR_MULTIFORMATSTART_draw(const char *contents, FILE *out, drawingStates *states);    /* last of reserved but not used */
    int U_PMR_MULTIFORMATSECTION_draw(const char *contents, FILE *out, drawingStates *states);  /* last of reserved but not used */
    int U_PMR_MULTIFORMATEND_draw(const char *contents, FILE *out, drawingStates *states);      /* last of reserved but not used */
