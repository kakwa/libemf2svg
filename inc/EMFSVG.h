...
#define BUFFERSIZE 1024
    ...
    void pixelformatdescriptor_draw(drawingStates *states, U_PIXELFORMATDESCRIPTOR pfd);
    void emrtext_draw(drawingStates *states, const char *emt, const char *record, int type);
