/**
  ...
  EMF+ file Record structure derived from Microsoft's EMF+ Information pdf,
  releade date July 5,2012, link from
  here:
...
#define U_FILTER_APPLY                                                         \
    1 //!<  With U_PMR_DRAWIMAGEPOINTS_set, use whatever filter has been set up
      //! up.
#define U_FILTER_IGNORE                                                        \
    0 //!<  With U_PMR_DRAWIMAGEPOINTS_set, ignore whatever filter has been set
      //! up up.
...
/** \defgroup U_PMF_DD_  PMF "standard" custom Dash Dot patterns for lines.
  ...
  U_DD_DASH, U_DD_DOT, U_DD_DASHDOT, and U_DD_DASHDOTDOT are the only ones with
  corresponding
    standard EMF and EMF+ dash/dot patterns.

  These values are used to tell U_PMF_DASHEDLINEDATA_set2() to create one of 27
  custom line patterns.
  Other custom line patterns may be created using U_PMF_DASHEDLINEDATA_set(),
  but this provides an easier
  way to get the same result if one of these patterns is acceptable.

  The length is divided by 2X the number of elements, so dashdash has twice as
  many
  dashes of half the length as just dash.
        ...
        Example: DotDot has (sub)unit length 1/2, so each dot will be 1/16 of
  unit length.
...
#define U_PMR_SETTEXTRENDERINGHINT                                             \
    0x001F                           //!< U_PMRSetTextRenderingHint    record
#define U_PMR_SETTEXTCONTRAST 0x0020 //!< U_PMRSetTextContrast         record
#define U_PMR_SETINTERPOLATIONMODE                                             \
    0x0021                              //!< U_PMRSetInterpolationMode    record
...
#define U_PMR_SETCOMPOSITINGQUALITY                                            \
    0x0024                          //!< U_PMRSetCompositingQuality   record
...
#define U_PMR_BEGINCONTAINERNOPARAMS                                           \
    0x0028                             //!< U_PMRBeginContainerNoParams  record
...
#define U_PMR_RESETWORLDTRANSFORM                                              \
    0x002B //!< U_PMRResetWorldTransform     record
#define U_PMR_MULTIPLYWORLDTRANSFORM                                           \
    0x002C //!< U_PMRMultiplyWorldTransform  record
#define U_PMR_TRANSLATEWORLDTRANSFORM                                          \
    0x002D //!< U_PMRTranslateWorldTransform record
#define U_PMR_SCALEWORLDTRANSFORM                                              \
    0x002E //!< U_PMRScaleWorldTransform     record
#define U_PMR_ROTATEWORLDTRANSFORM                                             \
    0x002F                              //!< U_PMRRotateWorldTransform    record
...
#define U_PMR_RECFLAG                                                          \
    0x4000 //!< In EMF+ files the type is one of the above + this flag
...
#define U_PMF_CUSTOMLINECAP_OID                                                \
    0x02020102                     //!< PMF_CUSTOMLINECAP PseudoObject type.
#define U_PMF_FONT_OID 0x02020103  //!< PMF_FONT PseudoObject type.
#define U_PMF_IMAGE_OID 0x02020104 //!< PMF_IMAGE PseudoObject type.
#define U_PMF_IMAGEATTRIBUTES_OID                                              \
    0x02020105                      //!< PMF_IMAGEATTRIBUTES PseudoObject type.
...
#define U_PMF_STRINGFORMAT_OID                                                 \
    0x02020109                          //!< PMF_STRINGFORMAT PseudoObject type.
...
#define U_PMF_BLENDFACTORS_OID                                                 \
    0x02020205 //!< PMF_BLENDFACTORS PseudoObject type.
#define U_PMF_BOUNDARYPATHDATA_OID                                             \
    0x02020206 //!< PMF_BOUNDARYPATHDATA PseudoObject type.
#define U_PMF_BOUNDARYPOINTDATA_OID                                            \
    0x02020207 //!< PMF_BOUNDARYPOINTDATA PseudoObject type.
#define U_PMF_CHARACTERRANGE_OID                                               \
    0x02020208 //!< PMF_CHARACTERRANGE PseudoObject type.
#define U_PMF_COMPOUNDLINEDATA_OID                                             \
    0x02020209 //!< PMF_COMPOUNDLINEDATA PseudoObject type.
#define U_PMF_COMPRESSEDIMAGE_OID                                              \
    0x02020210 //!< PMF_COMPRESSEDIMAGE PseudoObject type.
#define U_PMF_CUSTOMENDCAPDATA_OID                                             \
    0x02020211 //!< PMF_CUSTOMENDCAPDATA PseudoObject type.
#define U_PMF_CUSTOMLINECAPARROWDATA_OID                                       \
    0x02020212 //!< PMF_CUSTOMLINECAPARROWDATA PseudoObject type.
#define U_PMF_CUSTOMLINECAPDATA_OID                                            \
    0x02020213 //!< PMF_CUSTOMLINECAPDATA PseudoObject type.
#define U_PMF_CUSTOMLINECAPOPTIONALDATA_OID                                    \
    0x02020214 //!< PMF_CUSTOMLINECAPOPTIONALDATA PseudoObject type.
#define U_PMF_CUSTOMSTARTCAPDATA_OID                                           \
    0x02020215 //!< PMF_CUSTOMSTARTCAPDATA PseudoObject type.
#define U_PMF_DASHEDLINEDATA_OID                                               \
    0x02020216 //!< PMF_DASHEDLINEDATA PseudoObject type.
#define U_PMF_FILLPATHOBJ_OID 0x02020217 //!< PMF_FILLPATHOBJ PseudoObject type.
#define U_PMF_FOCUSSCALEDATA_OID                                               \
    0x02020218 //!< PMF_FOCUSSCALEDATA PseudoObject type.
#define U_PMF_GRAPHICSVERSION_OID                                              \
    0x02020219 //!< PMF_GRAPHICSVERSION PseudoObject type.
#define U_PMF_HATCHBRUSHDATA_OID                                               \
    0x02020220                        //!< PMF_HATCHBRUSHDATA PseudoObject type.
...
#define U_PMF_LANGUAGEIDENTIFIER_OID                                           \
    0x02020223 //!< PMF_LANGUAGEIDENTIFIER PseudoObject type.
#define U_PMF_LINEARGRADIENTBRUSHDATA_OID                                      \
    0x02020224 //!< PMF_LINEARGRADIENTBRUSHDATA PseudoObject type.
#define U_PMF_LINEARGRADIENTBRUSHOPTIONALDATA_OID                              \
    0x02020225 //!< PMF_LINEARGRADIENTBRUSHOPTIONALDATA PseudoObject type.
...
#define U_PMF_PATHGRADIENTBRUSHDATA_OID                                        \
    0x02020229 //!< PMF_PATHGRADIENTBRUSHDATA PseudoObject type.
#define U_PMF_PATHGRADIENTBRUSHOPTIONALDATA_OID                                \
    0x02020230 //!< PMF_PATHGRADIENTBRUSHOPTIONALDATA PseudoObject type.
#define U_PMF_PATHPOINTTYPE_OID                                                \
    0x02020231 //!< PMF_PATHPOINTTYPE PseudoObject type.
#define U_PMF_PATHPOINTTYPERLE_OID                                             \
    0x02020232 //!< PMF_PATHPOINTTYPERLE PseudoObject type.
#define U_PMF_PENDATA_OID 0x02020233 //!< PMF_PENDATA PseudoObject type.
#define U_PMF_PENOPTIONALDATA_OID                                              \
    0x02020234                      //!< PMF_PENOPTIONALDATA PseudoObject type.
...
#define U_PMF_REGIONNODECHILDNODES_OID                                         \
    0x02020241 //!< PMF_REGIONNODECHILDNODES PseudoObject type.
#define U_PMF_REGIONNODEPATH_OID                                               \
    0x02020242 //!< PMF_REGIONNODEPATH PseudoObject type.
#define U_PMF_SOLIDBRUSHDATA_OID                                               \
    0x02020243 //!< PMF_SOLIDBRUSHDATA PseudoObject type.
#define U_PMF_STRINGFORMATDATA_OID                                             \
    0x02020244 //!< PMF_STRINGFORMATDATA PseudoObject type.
#define U_PMF_TEXTUREBRUSHDATA_OID                                             \
    0x02020245 //!< PMF_TEXTUREBRUSHDATA PseudoObject type.
#define U_PMF_TEXTUREBRUSHOPTIONALDATA_OID                                     \
    0x02020246 //!< PMF_TEXTUREBRUSHOPTIONALDATA PseudoObject type.
#define U_PMF_TRANSFORMMATRIX_OID                                              \
    0x02020247                       //!< PMF_TRANSFORMMATRIX PseudoObject type.
#define U_PMF_IE_BLUR_OID 0x02020301 //!< PMF_IE_BLUR PseudoObject type.
#define U_PMF_IE_BRIGHTNESSCONTRAST_OID                                        \
    0x02020302 //!< PMF_IE_BRIGHTNESSCONTRAST PseudoObject type.
#define U_PMF_IE_COLORBALANCE_OID                                              \
    0x02020303 //!< PMF_IE_COLORBALANCE PseudoObject type.
#define U_PMF_IE_COLORCURVE_OID                                                \
    0x02020304 //!< PMF_IE_COLORCURVE PseudoObject type.
#define U_PMF_IE_COLORLOOKUPTABLE_OID                                          \
    0x02020305 //!< PMF_IE_COLORLOOKUPTABLE PseudoObject type.
#define U_PMF_IE_COLORMATRIX_OID                                               \
    0x02020306 //!< PMF_IE_COLORMATRIX PseudoObject type.
#define U_PMF_IE_HUESATURATIONLIGHTNESS_OID                                    \
    0x02020307 //!< PMF_IE_HUESATURATIONLIGHTNESS PseudoObject type.
#define U_PMF_IE_LEVELS_OID 0x02020308 //!< PMF_IE_LEVELS PseudoObject type.
#define U_PMF_IE_REDEYECORRECTION_OID                                          \
    0x02020309 //!< PMF_IE_REDEYECORRECTION PseudoObject type.
...
#define U_PMR_STROKEFILLPATH_OID                                               \
    0x02010101 //!< PMR_STROKEFILLPATH PseudoObject type. (Mentioned in passing
               //! here).
...
#define U_PMR_SETCLIPREGION_OID                                                \
    0x02030105                         //!< PMR_SETCLIPREGION PseudoObject type.
...
#define U_PMR_DRAWCLOSEDCURVE_OID                                              \
    0x02030404 //!< PMR_DRAWCLOSEDCURVE PseudoObject type.
#define U_PMR_DRAWCURVE_OID 0x02030405 //!< PMR_DRAWCURVE PseudoObject type.
#define U_PMR_DRAWDRIVERSTRING_OID                                             \
    0x02030406 //!< PMR_DRAWDRIVERSTRING PseudoObject type.
...
#define U_PMR_DRAWIMAGEPOINTS_OID                                              \
    0x02030409 //!< PMR_DRAWIMAGEPOINTS PseudoObject type.
...
#define U_PMR_FILLCLOSEDCURVE_OID                                              \
    0x02030415 //!< PMR_FILLCLOSEDCURVE PseudoObject type.
...
#define U_PMR_SERIALIZABLEOBJECT_OID                                           \
    0x02030502 //!< PMR_SERIALIZABLEOBJECT PseudoObject type.
#define U_PMR_SETANTIALIASMODE_OID                                             \
    0x02030601 //!< PMR_SETANTIALIASMODE PseudoObject type.
#define U_PMR_SETCOMPOSITINGMODE_OID                                           \
    0x02030602 //!< PMR_SETCOMPOSITINGMODE PseudoObject type.
#define U_PMR_SETCOMPOSITINGQUALITY_OID                                        \
    0x02030603 //!< PMR_SETCOMPOSITINGQUALITY PseudoObject type.
#define U_PMR_SETINTERPOLATIONMODE_OID                                         \
    0x02030604 //!< PMR_SETINTERPOLATIONMODE PseudoObject type.
#define U_PMR_SETPIXELOFFSETMODE_OID                                           \
    0x02030605 //!< PMR_SETPIXELOFFSETMODE PseudoObject type.
#define U_PMR_SETRENDERINGORIGIN_OID                                           \
    0x02030606 //!< PMR_SETRENDERINGORIGIN PseudoObject type.
#define U_PMR_SETTEXTCONTRAST_OID                                              \
    0x02030607 //!< PMR_SETTEXTCONTRAST PseudoObject type.
#define U_PMR_SETTEXTRENDERINGHINT_OID                                         \
    0x02030608 //!< PMR_SETTEXTRENDERINGHINT PseudoObject type.
#define U_PMR_BEGINCONTAINER_OID                                               \
    0x02030701 //!< PMR_BEGINCONTAINER PseudoObject type.
#define U_PMR_BEGINCONTAINERNOPARAMS_OID                                       \
    0x02030702 //!< PMR_BEGINCONTAINERNOPARAMS PseudoObject type.
#define U_PMR_ENDCONTAINER_OID                                                 \
    0x02030703                         //!< PMR_ENDCONTAINER PseudoObject type.
...
#define U_PMR_SETTSGRAPHICS_OID                                                \
    0x02030802 //!< PMR_SETTSGRAPHICS PseudoObject type.
#define U_PMR_MULTIPLYWORLDTRANSFORM_OID                                       \
    0x02030901 //!< PMR_MULTIPLYWORLDTRANSFORM PseudoObject type.
#define U_PMR_RESETWORLDTRANSFORM_OID                                          \
    0x02030902 //!< PMR_RESETWORLDTRANSFORM PseudoObject type.
#define U_PMR_ROTATEWORLDTRANSFORM_OID                                         \
    0x02030903 //!< PMR_ROTATEWORLDTRANSFORM PseudoObject type.
#define U_PMR_SCALEWORLDTRANSFORM_OID                                          \
    0x02030904 //!< PMR_SCALEWORLDTRANSFORM PseudoObject type.
#define U_PMR_SETPAGETRANSFORM_OID                                             \
    0x02030905 //!< PMR_SETPAGETRANSFORM PseudoObject type.
#define U_PMR_SETWORLDTRANSFORM_OID                                            \
    0x02030906 //!< PMR_SETWORLDTRANSFORM PseudoObject type.
#define U_PMR_TRANSLATEWORLDTRANSFORM_OID                                      \
    0x02030907 //!< PMR_TRANSLATEWORLDTRANSFORM PseudoObject type.
#define U_PMR_TRANSLATEWORLDTRANSFORM_OID                                      \
    0x02030907 //!< PMR_TRANSLATEWORLDTRANSFORM PseudoObject type.
#define U_PMR_CMN_HDR_OID 0x40000000 //!< PMR_CMN_HDR PseudoObject type.
#define U_PMF_4NUM_OID                                                         \
    0x40000001 //!< PMF_4NUM PseudoObject type. PseudoObject contains a 4
//! unsigned int in EMF+ file byte order, used in some contexts to
//! indicate an object index number..
#define U_PMF_RAW_OID                                                          \
    0x40000002 //!< PMF_RAW PseudoObject type. Raw data: no preceding elements,
               //! data has native endianness.
#define U_PMF_ARRAY_OID                                                        \
    0x80000000 //!< PMF_ARRAY PseudoObject type modifier. PseudoObject contains
               //! an array of the data type revealed when this bit is cleared.
#define U_PMF_MASK_OID                                                         \
    0x7FFFFFFF //!< PMF_MASK.  Select PseudoObject data type without regard to
               //! PMF_ARRAY.
...
#define U_CM_Intersect                                                         \
    0x01 //!< Region becomes intersection of existing region and new region.
...
#define U_CM_Exclude                                                           \
    0x04 //!< Region becomes part of existing region not in new region.
#define U_CM_Complement                                                        \
    0x05 //!< Region becomes part of new region not in existing region.
         /** @} */

/** \defgroup U_PMF_CMS_ PMF CompositingMode Enumeration
  For
  EMF+ manual 2.1.1.5, Microsoft name: CompositingMode Enumeration (U_CMS_*
  [S==Source])
  @{
*/
...
/** \defgroup U_PMF_CLCDT_ PMF CustomLineCapDataType Enumeration
  For
  EMF+ manual 2.1.1.9, Microsoft name: CustomLineCapDataType Enumeration
  (U_CLCDT_*)
  @{
*/
...
/** \defgroup U_PMF_HSP_ PMF HatchStyle Enumeration
  For
  EMF+ manual 2.1.1.13, Microsoft name: HatchStyle Enumeration   (U_HSP_* [U_HS_
  already used for EMF])
  @{
*/
...
#define U_IM_HighQualityBilinear                                               \
    0x06 //!< High Quality Bilinear interpolation mode
#define U_IM_HighQualityBicubic                                                \
    0x07 //!< High Quality Bicubic interpolation mode
         /** @} */
...
#define U_LID_LANG_NEUTRAL_CUSTOM_DEFAULT                                      \
    0x0C00                               //!< LANG_NEUTRAL_CUSTOM_DEFAULT
...
#define U_LID_LANG_NEUTRAL_CUSTOM_DEFAULT_MUI                                  \
    0x1400                      //!< LANG_NEUTRAL_CUSTOM_DEFAULT_MUI
...
#define U_PF_16bppARGB1555                                                     \
    0x00061007 //!<  16 bit ARGB values (1 alpha, 5,5,5 colors)
...
#define U_PF_32bppPARGB                                                        \
    0x000E200B //!<  32 bit PARGB values (8,8,8,8, but RGB already multiplied by
               //! A)
#define U_PF_48bppRGB 0x0010300C  //!<  48 bit RGB (16,16,16)
#define U_PF_64bppARGB 0x0034400D //!<  64 bit ARGB (16 alpha, 16,16,16)
#define U_PF_64bppPARGB                                                        \
    0x001A400E //!<  64 bit PARGB (16,16,16,16, but RGB already multiplied by A)
               /** @} */
...
#define U_RNDT_Exclude                                                         \
    0x00000004 //!< Part of 1st child node not in 2nd child node
#define U_RNDT_Complement                                                      \
    0x00000005                 //!< Part of 2nd child node not in 1st child node
...
/** \defgroup U_PMF_SA_ PMF StringAlignment Enumeration
  ...
  Note, that unlike EMF these are with respect to the bounding rectangle, not to
  a single point. So
  to draw centered text, for instance, U_SA_Center must be used, and the
  bounding rectangle must also be
  centered.

  For horizontal positioning of L->R text Near is all the way left in the box,
  Far is all the way right,
  and Center puts the center of the text in the center of the box.

  For vertical positioning things are a little strange.  Near is a certain
  distance down from the top, Far is a
  certain distance up from the bottom, and center puts the center of the text in
  the center of the box.  The
  "certain distance" is not specified in the EMF+ documentation. See the
  function U_PMR_drawstring() for an
...
/** \defgroup U_PMF_SDS_ PMF StringDigitSubstitution Enumeration
  For
  EMF+ manual 2.1.1.30, Microsoft name: StringDigitSubstitution Enumeration
  (U_SDS_*)
  @{
*/
...
#define U_WM_TileFlipXY                                                        \
    0x00000003                //!< Reverse horizontally and vertically then tile
...
/** \defgroup U_PMF_BD_ PMF BrushData Flags
  ...
  Bit flags allowed in brush object types.  Each bit indicates a type of object
  which is included.
...
#define U_BD_BlendFactorsV                                                     \
    0x0010 //!< BlendFactorsV in {A} - Note, not actually implemented in GDI+.
...
#define U_DSO_CmapLookup                                                       \
    0x01 //!< Set: value is a Unicode character; Clear: value is an index into
         //! Glyph table in a font
#define U_DSO_Vertical                                                         \
    0x02 //!< Set: draw string verically; Clear: draw horizontally
#define U_DSO_RealizedAdvance                                                  \
    0x04 /**< Set: U_PMF_DRAWDRIVERSTRING Positions field specifies only       \
            position of first of Glyphs field,                                 \
              with the rest calculated from font information; Clear: Positions \
            specifies coordinates for each Glyphs member.*/
#define U_DSO_LimitSubpixel                                                    \
    0x08 //!< Set: use less memory to cache anti-aliased glyphs; Clear: use more
         /** @} */
...
If bit is set the corresponding object must be specfied in the OptionalData
field
...
#define U_SF_DisplayFormatControl                                              \
    0x00000020 //!< control codes display as "representative" glyphs
...
#define U_SF_MeasureTrailingSpaces                                             \
    0x00000800                    //!< trailing spaces included in line length
...
#define U_SF_BypassGDI                                                         \
    0x80000000 //!< use implementation specific text rendering instead of GDI
               /** @} */
...
/** \defgroup U_PMF_IE_ PMF ImageEffects Identifiers
  ...
  @{
*/
#define U_IE_BlurEffectGuid                                                    \
    "{633C80A4-1843-482B-9EF2-BE2834C5FDD4}" //!< Blur Effect
#define U_IE_BrightnessContrastEffectGuid                                      \
    "{D3A1DBE1-8EC4-4C17-9F4C-EA97AD1C343D}" //!< Brightness Contrast Effect
#define U_IE_ColorBalanceEffectGuid                                            \
    "{537E597D-251E-48DA-9664-29CA496B70F8}" //!< Color Balance Effect
#define U_IE_ColorCurveEffectGuid                                              \
    "{DD6A0022-58E4-4A67-9D9B-D48EB881A53D}" //!< Color Curve Effect
#define U_IE_ColorLookupTableEffectGuid                                        \
    "{A7CE72A9-0F7F-40D7-B3CC-D0C02D5C3212}" //!< Color Lookup Table Effect
#define U_IE_ColorMatrixEffectGuid                                             \
    "{718F2615-7933-40E3-A511-5F68FE14DD74}" //!< Color Matrix Effect
#define U_IE_HueSaturationLightnessEffectGuid                                  \
    "{8B2DD6C3-EB07-4D87-A5F0-7108E26A9C5F}" //!< Hue Saturation Lightness
                                             //! Effect
#define U_IE_LevelsEffectGuid                                                  \
    "{99C354EC-2A31-4F3A-8C34-17A803B33A25}" //!< Levels Effect
#define U_IE_RedEyeCorrectionEffectGuid                                        \
    "{74D29D05-69A4-4266-9549-3CC52836B632}" //!< Red Eye Correction Effect
#define U_IE_SharpenEffectGuid                                                 \
    "{63CBF3EE-C526-402C-8F71-62C540BF5142}" //!< Sharpen Effect
#define U_IE_TintEffectGuid                                                    \
    "{1077AF00-2848-4441-9489-44AD4C2D7A2C}" //!< Tint Effect
                                             /** @} */
...
#define U_IEE_HueSaturationLightnessEffectGuid                                 \
    7                                      //!< Hue Saturation Lightness Effect
...
/** \defgroup U_PMF_PPF_ PMF PathPoint Flags
        ...
        NOTE:  bitfields in manual are BIG endian and MSB 0.
               This code reads the 16 bit flag field as LITTLE endian and uses
  LSB 0.
               The values shown are AFTER the data has been read into a uint16_t
  and the byte order set
                 appropriately.
        All of these come out of a 16 bit field.
  @{
*/
#define U_PPF_B                                                                \
    0x8000 //!< 15 Set: BrushID is an U_PFM_ARGB; Clear: is index of U_PMF_BRUSH
           //! object in EMF+ object table.
#define U_PPF_BZ                                                               \
    0x8000 //!< 15 Set: Points are on a Bezier curve; Clear: Points are on a
           //! line
#define U_PPF_N                                                                \
    0x8000 //!< 15 Set: object definition continues in next record; Clear: this
           //! is the final object definition record
#define U_PPF_K                                                                \
    0x8000 //!< 15 Set: int16_t coordinates; Clear: use U_FLOAT coordinates
#define U_PPF_C                                                                \
    0x4000 //!< 14 Set: int16_t coordinates; Clear: use U_FLOAT coordinates
#define U_PPF_XM                                                               \
    0x2000 //!< 13 Set: Post multiply matrix; Clear: Pre multiply matrix
#define U_PPF_F 0x2000 //!< 13 Set: winding fill; Clear: alternate fill
#define U_PPF_E                                                                \
    0x2000 //!< 13 Set: effect from previous U_PMF_SERIALIZABLEOBJECT record
           //! will be applied,; Clear: no effect applied
#define U_PPF_R                                                                \
    0x1000 //!< 12 Set: U_PMF_PathPointTypeRLE and/or U_PMF_PathPointType
           //! objects; Clear: only U_PMF_PathPointType
#define U_PPF_P                                                                \
    0x0800 //!< 11 Set: relative coordinates; Clear absolute coordinates
#define U_PPF_D 0x0400 //!< 10 Set: draw path closed; Clear: draw path open
#define U_PPF_VGA                                                              \
    0x0002 //!<  1 Set: Palette is VGA basic colors; Clear: Palette is ???
#define U_PPF_PP                                                               \
    0x0001 //!<  0 Set: Palette field is present; Clear: Palette field is absent
...
#define U_PPF_VIDEO                                                            \
    0x0001 //!<  0 Set: reference device is video display; Clear: reference
           //! devis is printer
           /** @} */
...
/** \defgroup U_PMF_FF_ PMF Masks and offsets for 16 bit flag fields
  ...
  Note, some of these are used in more than one record type, only a single
  reference is provided
  @{
*/

#define U_FF_MASK_SUBLID                                                       \
    0x003F //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_SHFT_SUBLID                                                       \
    0x000A //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_MASK_PRILID                                                       \
    0x03FF //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_SHFT_PRILID                                                       \
    0x0000 //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_MASK_LID                                                          \
    0xFFFF //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_SHFT_LID                                                          \
    0x0000 //!< EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
#define U_FF_MASK_RL                                                           \
    0x003F //!< EMF+ manual 2.2.2.32, Microsoft name: EmfPlusPathPointTypeRLE
#define U_FF_SHFT_RL                                                           \
    0x0008 //!< EMF+ manual 2.2.2.32, Microsoft name: EmfPlusPathPointTypeRLE
#define U_FF_MASK_PPT                                                          \
    0x00FF //!< EMF+ manual 2.2.2.32, Microsoft name: EmfPlusPathPointTypeRLE
#define U_FF_SHFT_PPT                                                          \
    0x0000 //!< EMF+ manual 2.2.2.32, Microsoft name: EmfPlusPathPointTypeRLE
/* the next one is used most places an object ID is specified */
#define U_FF_MASK_OID8                                                         \
    0x00FF //!< EMF+ manual 2.3.1.3, Microsoft name: EmfPlusSetClipPath
#define U_FF_SHFT_OID8                                                         \
    0x0000 //!< EMF+ manual 2.3.1.3, Microsoft name: EmfPlusSetClipPath
#define U_FF_MASK_CM4                                                          \
    0x000F //!< EMF+ manual 2.3.1.3, Microsoft name: EmfPlusSetClipPath
#define U_FF_SHFT_CM4                                                          \
    0x0008 //!< EMF+ manual 2.3.1.3, Microsoft name: EmfPlusSetClipPath
#define U_FF_MASK_OT                                                           \
    0x003F //!< EMF+ manual 2.3.5.1, Microsoft name: EmfPlusObject
#define U_FF_SHFT_OT                                                           \
    0x0008 //!< EMF+ manual 2.3.5.1, Microsoft name: EmfPlusObject
#define U_FF_MASK_AA                                                           \
    0x007F //!< EMF+ manual 2.3.6.1, Microsoft name: EmfPlusSetAntiAliasMode
#define U_FF_SHFT_AA                                                           \
    0x0001 //!< EMF+ manual 2.3.6.1, Microsoft name: EmfPlusSetAntiAliasMode
#define U_FF_MASK_CM                                                           \
    0x00FF //!< EMF+ manual 2.3.6.2, Microsoft name: EmfPlusSetCompositingMode
#define U_FF_SHFT_CM                                                           \
    0x0000 //!< EMF+ manual 2.3.6.2, Microsoft name: EmfPlusSetCompositingMode
#define U_FF_MASK_CQ 0x00FF //!< EMF+ manual 2.3.6.3, Microsoft name:
                            //! EmfPlusSetCompositingQuality
#define U_FF_SHFT_CQ 0x0000 //!< EMF+ manual 2.3.6.3, Microsoft name:
                            //! EmfPlusSetCompositingQuality
#define U_FF_MASK_IM                                                           \
    0x00FF //!< EMF+ manual 2.3.6.4, Microsoft name: EmfPlusSetInterpolationMode
#define U_FF_SHFT_IM                                                           \
    0x0000 //!< EMF+ manual 2.3.6.4, Microsoft name: EmfPlusSetInterpolationMode
#define U_FF_MASK_PxOffM                                                       \
    0x00FF //!< EMF+ manual 2.3.6.5, Microsoft name: EmfPlusSetPixelOffsetMode
#define U_FF_SHFT_PxOffM                                                       \
    0x0000 //!< EMF+ manual 2.3.6.5, Microsoft name: EmfPlusSetPixelOffsetMode
#define U_FF_MASK_TGC                                                          \
    0x0FFF //!< EMF+ manual 2.3.6.7, Microsoft name: EmfPlusSetTextContrast
#define U_FF_SHFT_TGC                                                          \
    0x0000 //!< EMF+ manual 2.3.6.7, Microsoft name: EmfPlusSetTextContrast
#define U_FF_MASK_TRH                                                          \
    0x00FF //!< EMF+ manual 2.3.6.8, Microsoft name: EmfPlusSetTextRenderingHint
#define U_FF_SHFT_TRH                                                          \
    0x0000 //!< EMF+ manual 2.3.6.8, Microsoft name: EmfPlusSetTextRenderingHint
#define U_FF_MASK_UT                                                           \
    0x00FF //!< EMF+ manual 2.3.7.1, Microsoft name: EmfPlusBeginContainer
#define U_FF_SHFT_UT                                                           \
    0x0008 //!< EMF+ manual 2.3.7.1, Microsoft name: EmfPlusBeginContainer
#define U_FF_MASK_TSC                                                          \
    0x7FFF //!< EMF+ manual 2.3.8.1, Microsoft name: EmfPlusSetTSClip
#define U_FF_SHFT_TSC                                                          \
    0x0000 //!< EMF+ manual 2.3.8.1, Microsoft name: EmfPlusSetTSClip
#define U_FF_MASK_PU                                                           \
    0x00FF //!< EMF+ manual 2.3.9.5, Microsoft name: EmfPlusSetPageTransform
#define U_FF_SHFT_PU                                                           \
    0x0000 //!< EMF+ manual 2.3.9.5, Microsoft name: EmfPlusSetPageTransform
           /** @} */
...
/**  @brief  Used to accumulate data for objects continued over multiple
  records.
...
typedef struct {
    ...
    size_t Size; /**< Number of bytes allocated in Data (may be >Used if padding
                    is present) */
    size_t Used; /**< Number of data bytes that are stored in Data  */
    uint32_t
        Type; /**< Type numbers are from manual section: 1.2.3.4 -> 10203040 */
} U_PSEUDO_OBJ;

/** @brief DoublePseudoObject holds pairs of PseudoObjects.  Used for
  constructing paths along with their types.
  The data stored in the PsuedoObjects maintains LittleEndian-ness, as expected
  in the final file.
...
An array of these are passed to U_PMF_SERIAL_set() to construct EMF+ objects
from their component parts.
The U_PMF_SERIAL_set() function should not ever be called directly by end user
code.
*/
typedef struct {
...
/** @brief FontInfoParams hold font information that is needed by
  U_PMR_drawstring so that it can
  place text on the baseline.  This must be extracted from the font file using
  an appropriate utility.  (See testbed_pmf.c for a table of these values for
  some
  common fonts.)
*/
typedef struct {
...
variable part of object follows structure:
         uint32_t            Data[];             // one of the 5 types of Brush
data (2.2.2 20, 24, 29, 43, or 45)
*/
typedef struct {
...
typedef struct {
    ...
    uint32_t Type;    //!< BrushType Enumeration
                      /* variable part of object, not part of structure
                          uint32_t            Data[];             //!< one of the 2 types of
                         Linecap data (2.2.2 12, 13)
                      */
    /*@}*/
} U_PMF_CUSTOMLINECAP;
...
typedef struct {
    ...
    uint32_t Length;   //!< Number of Unicode Characters in FamilyName
                       /* variable part of object, not part of structure
                           uint16_t            FamilyName[];       //!< Unicode (UTF-16LE) name of
                          font family
                       */
    /*@}*/
} U_PMF_FONT;
...
typedef struct {
    ...
    uint32_t Type;    //!< ImageDataType Enumeration
                      /* variable part of object, not part of structure
                          uint32_t            Data[];             //!< one of the 2 types of image
                         data (2.2.2 2 or 27)
                      */
    /*@}*/
} U_PMF_IMAGE;

/** @brief EMF+ manual 2.2.2.1, Microsoft name: EmfPlusARGB Object, out of
 * order, needed for 2.2.1.5 */
typedef struct {
    /*@{*/
...
/** @brief EMF+ manual 2.2.2.40, Microsoft name: EmfPlusRegionNode Object, out
 * of order, needed for 2.2.1.8 */
typedef struct {
    uint32_t Type; //!< RegionNodeDataType
    /* variable part of object, not part of structure, will be absent in object
       for some types
...
/** @brief EMF+ manual 2.2.2.23, Microsoft name: EmfPlusLanguageIdentifier
Object, out of order, needed for 2.2.1.9

Bit fields are not used in structs in this implementation, these are
serialized/deserialized in
the corresponding routines.  Bitfields in the FILE (LITTLE endian here, manual
uses BIG endian) are:
        int              SubLId : 6;           Example: code for USA
        int              PriLId : 10;          Example: code for English

This type is defined as 16 bits in the manual section, but it is only ever used
as part of a 32 bit field!
*/
...
typedef struct {
    ...
    U_FLOAT
    LeadingMargin; //!< space before starting position (text) of a string
    U_FLOAT TrailingMargin; //!< space after last position (text) of a string
    U_FLOAT Tracking;       //!< horizontal space alotted per character/font
                            //! specification per character
    uint32_t Trimming;      //!< StringTrimming enumeration
    uint32_t TabStopCount;  //!< Number of tab stops in data field.
    uint32_t
        RangeCount; //!< Number of U_PMF_CHARACTERRANGE objects in data field.
                    /* variable part of object, not part of structure.
                        U_PMF_STRINGFORMATDATA  data
                
                       Note that U_PMF_STRINGFORMATDATA has no struct as it is entirely variable
                       and the size of the two fields in it are specified by the two preceding
                       fields in this object type.
                    */
} U_PMF_STRINGFORMAT;

/** U_PMF_ARGB EMF+ manual 2.2.2.1, Microsoft name: EmfPlusARGB Object, defined
 * above, before 2.2.1.6*/
...
typedef struct {
    ...
    uint32_t Type;     //!< BitmapDataType enumeration (section 2.1.1.2).
                       /* variable part of object, not part of structure.
                           (various types)     BitmapData          //!< is either an
                          U_PMF_BITMAPDATA or U_PMF_COMPRESSEDIMAGE object
                       */
} U_PMF_BITMAP;

/** U_PMF_BITMAPDATA EMF+ manual 2.2.2.3, Microsoft name: EmfPlusBitmapData
Object
U_PMF_BITMAPDATA is an entirely variable object, there is no corresponding
struct.  It consists of

   Colors    U_PMF_PALETTE object
   PixelData An array of bytes, meaning depends on fields in U_PMF_BITMAP object
and the PixelFormat enumeration.
...
typedef struct {
    uint32_t Elements; //!< members in each array
                       /* variable part of object, not part of structure.
                           U_FLOAT             Positions           //!< positions along gradient
                          line. The first position MUST be 0.0 and the last MUST be 1.0.
                           U_PMF_ARGB          Colors              //!< colors at positions on
                          gradient line
                       */
} U_PMF_BLENDCOLORS;
...
typedef struct {
    uint32_t Elements; //!< Members in each array
                       /* variable part of object, not part of structure.
                           U_FLOAT             Positions           //!< positions along gradient
                          line. The first position MUST be 0.0 and the last MUST be 1.0.
                           U_FLOAT             Factors             //!< blending factors, 0.0->1.0
                          values, inclusive
                       */
} U_PMF_BLENDFACTORS;
...
alternates (sub)line width (as fraction of total width and gaps (also as
fraction
of total width).
*/
typedef struct {
    int32_t Elements; //!< Members in the array
                      /* variable part of object, not part of structure.
                          U_FLOAT             Data                //!< Line or gap width (0.0 <->
                         1.0, fraction of total line width )
                      */
...
/** @brief EMF+ manual 2.2.2.12, Microsoft name: EmfPlusCustomLineCapArrowData
 * Object */
typedef struct {
    U_FLOAT
...
/** U_PMF_CUSTOMLINECAPOPTIONALDATA EMF+ manual 2.2.2.14, Microsoft name:
...
/** @brief EMF+ manual 2.2.2.15, Microsoft name: EmfPlusCustomStartCapData
 * Object */
typedef struct {
    int32_t Size; //!< Bytes in Data
                  /* variable part of object, not part of structure.
...
typedef struct {
    int32_t Elements; //!< Elements in Data
                      /* variable part of object, not part of structure.
                          U_FLOAT             Data;               //!< Array of lengths of dashes
                         and spaces
                      */
...
uses BIG endian) are:
  ...
  @{
*/
typedef uint32_t U_PMF_GRAPHICSVERSION; //!< EMF+ manual 2.2.2.19, Microsoft
                                        //! name: EmfPlusGraphicsVersion Object
/** @} */
...
/** \defgroup U_PMF_Int15 PMF 15 bit signed integer
   ...
   This is the one data type that really does seem to be stored into the file in
  Big Endian order.
   It has to be this way because the bit that determines if data is int7 or
  int15 must be in the first byte
 ...
 * defined above, before 2.2.1.9  */

/** @brief EMF+ manual 2.2.2.39, Microsoft name: EmfPlusRectF Object, out of
 * order, needed for 2.2.2.24  */
typedef struct {
...
/** @brief EMF+ manual 2.2.2.24, Microsoft name: EmfPlusLinearGradientBrushData
Object
Manual says that Reserved1 and Reserved2 must be ignored.  In practice if
Reserved1 is not set to StartColor
and Reserved2 is not set to EndColor, then XP Preview will not display the
gradient.
*/
typedef struct {
    ...
    uint32_t Reserved2;    //!< ignore
                           /* variable part of object, not part of structure.
                               U_PMF_LINEARGRADIENTBRUSHOPTIONALDATA data;  //!< presence and meaning
                              depend on Flags field
                           */
} U_PMF_LINEARGRADIENTBRUSHDATA;

/** @brief EMF+ manual 2.2.2.47, Microsoft name: EmfPlusTransformMatrix Object,
 * out of order, needed for 2.2.2.25 */
typedef struct {
...
/** NOT DOCUMENTED.  Encountered in actual
   EmfPlusLinearGradientBrushOptionalData Object made by PowerPoint 2003.  This
...
/** @brief EMF+ manual 2.2.2.25, Microsoft name:
  EmfPlusLinearGradientBrushOptionalData Object
  For U_PMF_LINEARGRADIENTBRUSHDATA data field
*/
/* Entire object is variable and not part of a structure!
   U_PMF_LINEARGRADIENTBRUSHOPTIONALDATA
    U_PMF_ROTMATRIX             Matrix;     //!< Rotation matrix, Manuals says
   that this should be Transformation matrix, but last two values are missing
    (various)                   pattern;    //!< Presence and meaning depend on
   Flags field, see below

    Flag values
    U_BD_PresetColors U_BD_BlendFactorsH U_BD_BlendFactorsV    pattern(s)
   present?
    0                 0                  0                     none
    ...
    0                 1                  1
   U_PMF_BLENDFACTORS, U_PMF_BLENDFACTORS
*/
...
typedef struct {
    ...
    uint32_t Size; //!< Bytes in Data
                   /* variable part of object, not part of structure.
                       U_PMF_IMAGE         Data;               //!< Various types of data, like
                      an EMF metafile, WMF metafile, another EMF+ metafile
                   */
} U_PMF_METAFILE;
...
typedef struct {
    ...
    uint32_t Elements; //!< elements in Data
                       /* variable part of object, not part of structure.
                           U_PMF_ARGB          Data;               //!< Palette data (array of
                          colors)
                       */
} U_PMF_PALETTE;

/** @brief EMF+ manual 2.2.2.36, Microsoft name: EmfPlusPointF Object, out of
 * order, needed for 2.2.2.29 */
typedef struct {
    U_FLOAT X; //!< UL X value
    U_FLOAT Y; //!< UL Y value
} U_PMF_POINTF;

/** @brief EMF+ manual 2.2.2.29, Microsoft name: EmfPlusPathGradientBrushData
 * Object */
typedef struct {
    uint32_t Flags;         //!< BrushData flags
    int32_t WrapMode;       //!< WrapMode enumeration
    ...
    uint32_t Elements; //!< Number of elements in gradient (not counting center)
                       /* variable part of object, not part of structure.
                           U_PMF_ARGB          Gradient;           //!< Color Gradient with
                          Elements members
                           (varies)            Boundary;           //!< U_PMF_BOUNDARYPATHDATA
                          object if BrushDataPath bit set in Flag, else U_PMF_BOUNDARYPOINTDATA
                          object
                           U_PMF_GRADIENTBRUSHOPTIONALDATA data;   //!< exact composition depends
                          on Flags
                       */
...
typedef struct {
    ...
    U_PMF_BLENDCOLORS           Pattern;    //!< presence and meaning depend on
Flags field
                                                 Flag values
                                                 U_BD_PresetColors
U_BD_BlendFactorsH    pattern?
                                                 0                 0 none
                                                 1                 0
U_PMF_BLENDCOLORS
                                                 0                 1
U_PMF_BLENDFACTORS
    U_PMF_FOCUSSSCALEDATA       data        //!< Present if U_BD_FocusScales bit
set in Flags in U_PMF_PATHGRADIENTNBRUSHDATA object
...
Bitfields in the FILE (LITTLE endian here, manual uses BIG endian) are:
  ...
  @{
*/
typedef uint8_t U_PMF_PATHPOINTTYPE; //!< EMF+ manual 2.2.2.31, Microsoft name:
...
U_PMF_PATHPOINTTYPERLE fields specify point types in a path where the path is
Run Length Encoded.
Bit fields are not used in structs in this implementation, these are
serialized/deserialized in
the corresponding routines.  Bitfields in the FILE (LITTLE endian here, manual
uses BIG endian) are:
  ...
  @{
*/
typedef uint16_t U_PMF_PATHPOINTTYPERLE; //!< EMF+ manual 2.2.2.32, Microsoft
//! name: EmfPlusPathPointTypeRLE Object
/** @} */

/** @brief EMF+ manual 2.2.2.33, Microsoft name: EmfPlusPenData Object

Variable part of object follows structure:
        U_PMF_PENOPTIONALDATA data;  Optional pen data, exact composition
depends on Flags
*/
typedef struct {
...
Every part of this object is variable or optional, there is no corresponding
struct

                                                   Present if Flag        What
is it
    U_PMF_TRANSFORMMATRIX    Matrix           //!< U_PD_Transform
Transformation matrix
    int32_t                  StartCap         //!< U_PD_StartCap
LineCapType enumeration
    int32_t                  EndCap           //!< U_PD_EndCap
LineCapType enumeration
    uint32_t                 Join             //!< U_PD_Join
LineJoinType enumeration
    U_FLOAT                  MiterLimit       //!< U_PD_MiterLimit
Maximum (miter length / line width)
    int32_t                  Style            //!< U_PD_LineStyle
LineStyle enumeration
    int32_t                  DLCap            //!< U_PD_DLCap
DashedLineCapType enumeration
    U_FLOAT                  DLOffset         //!< U_PD_DLOffset
Distance line start to first dash start
    U_PMF_DASHEDLINEDATA     DLData           //!< U_PD_DLData            Dash
and space widths
    int32_t                  PenAlignment     //!< U_PD_NonCenter
PenAlignment enumeration
    U_PMF_COMPOUNDLINEDATA   CLData           //!< U_PD_CompoundLineData
Compount Line (parallel lines drawn instead of one)
    U_PMF_CUSTOMSTARTCAPDATA CSCapData        //!< U_PD_CustomStartCap    Custom
start cap
    U_PMF_CUSTOMENDCAPDATA   CECapData        //!< U_PD_CustomEndCap      Custom
end cap
 */
...
/** U_PMF_POINTF EMF+ manual 2.2.2.36, Microsoft name: EmfPlusPointF Object,
 * defined above, before 2.2.2.29 */
...
/** U_PMF_POINTR EMF+ manual 2.2.2.37, Microsoft name: EmfPlusPointR Object
  ...
  Any combination of the two allowed types of integer is valid.
    ...
    (varies)            X;                  //!< U_PMF_INTEGER7 or
  U_PMF_INTEGER15
    (varies)            Y;                  //!< U_PMF_INTEGER7 or
  U_PMF_INTEGER15
...
/** U_PMF_RECTF EMF+ manual 2.2.2.39, Microsoft name: EmfPlusRectF Object,
 * defined above, before 2.2.2.24  */

/** U_PMF_REGIONNODE EMF+ manual 2.2.2.40, Microsoft name: EmfPlusRegionNode
 * Object, defined above, before 2.2.1.8 */

/** U_PMF_REGIONNODECHILDNODES EMF+ manual 2.2.2.41, Microsoft name:
...
/** U_PMF_STRINGFORMATDATA EMF+ manual 2.2.2.44, Microsoft name:
  EmfPlusStringFormatData Object
  Both parts of this object are variable and optional, there is no corresponding
  struct
    U_FLOAT                TabStops[];      //!< Array of tabstop locations
    U_PMF_CHARACTERRANGE   CharRange[];     //!< Array of character ranges in
  the text
*/
...
/** U_PMF_TEXTUREBRUSHOPTIONALDATA EMF+ manual 2.2.2.46, Microsoft name:
EmfPlusTextureBrushOptionalData Object

Every part of this object is variable or optional, there is no corresponding
struct

        U_PMF_TRANSFORMMATRIX  Matrix;          Transformation matrix, present
if Flag BrushDataTransform is set.
        U_PMF_IMAGE            Image            Image that contains the texture.
Present if the PMR record that includes this object still has space
                                                  for an U_PMF_IMAGE after all
the other variable and optional data
                                                  within it has been accounted
for.
*/

/** U_PMF_TRANSFORMMATRIX EMF+ manual 2.2.2.47, Microsoft name:
 * EmfPlusTransformMatrix Object, defined above, before 2.2.2.25 */
...
typedef struct {
    ...
    uint32_t Size;  //!< Bytes in record, including this struct (will be a
                    //! multiple of 4)
    uint32_t
        DataSize; //!< Bytes of data that follow, may not be a multiple of 4.
} U_PMF_CMN_HDR;

/** These are the Image Effect Objects 2.2.3.*  They specify parameters for
 * "filters" that may be applied to bitmaps. */
 ...
 */
typedef struct {
    int32_t Brightness; //!< -255 to 255, 0 is unchanged, positive increases,
                        //! negative decreases
    int32_t Contrast;   //!< -100 to 100, 0 is unchanged, positive increases,
                        //! negative decreases
} U_PMF_IE_BRIGHTNESSCONTRAST;

/** @brief EMF+ manual 2.2.3.3, Microsoft name: ColorBalanceEffect Object */
typedef struct {
    int32_t CyanRed; //!< -100 to 100, 0 is unchanged, positive increases Red
                     //!& decreases Cyan,    negative is opposite
    int32_t MagentaGreen; //!< -100 to 100, 0 is unchanged, positive increases
                          //! Green & decreases Magenta, negative is opposite
    int32_t YellowBlue;   //!< -100 to 100, 0 is unchanged, positive increases
                          //! Blue  & decreases Yellow,  negative is opposite
...
typedef struct {
    ...
    int32_t Intensity; //!< adjustment to apply.  "Adjust" determines what field
...
typedef struct {
    U_FLOAT M[5][5]; //!< 5 x 5 color transformation matrix, First 4 rows are
                     //![{4 multiplier values},0.0] for R,G,B,A, last Row is [{4
                     //! color translation valuess}, 1.0]
} U_PMF_IE_COLORMATRIX;

/** @brief EMF+ manual 2.2.3.7, Microsoft name: HueSaturationLightnessEffect
 * Object */
typedef struct {
...
typedef struct {
    int32_t Elements; //!< Number of members in Rects
                      /*  variable part of object, not included in structure
                          U_RECTL             Rects[];            //!< Array of rectangular
                         area(s) to apply red eye correction
                      */
...
typedef struct {
    int32_t Hue;    //!< -180 to 180, [positive==clockwise] rotation in degrees
                    //! starting from blue
    int32_t Amount; //!< -100 [add black] to 100[add white], 0 is unchanged.
                    //! Change in hue on specified axis
} U_PMF_IE_TINT;

/* **************************  EMF+ Records ******************************** */

/** @brief EMF+ manual 2.3.1.1, Microsoft name: EmfPlusOffsetClip Record,  Index
 * 0x35 */
typedef struct {
...
/**  @brief U_PMF_RESETCLIP EMF+ manual 2.3.1.2, Microsoft name:
 * EmfPlusResetClip Record, Index 0x31 */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header (ignore flags)
} U_PMF_RESETCLIP;

/**  @brief EMF+ manual 2.3.1.3, Microsoft name: EmfPlusSetClipPath Record,
Index 0x33

flags (LITTLE endian here, manual uses BIG endian)
   bits 8-11   CombineMode enumeration
   bits 0-7    Index of an U_PMF_PATH object in the EMF+ object table (0-63,
inclusive)
*/
typedef struct {
...
/**  @brief EMF+ manual 2.3.1.4, Microsoft name: EmfPlusSetClipRect Record,
Index 0x32
...
/**  @brief EMF+ manual 2.3.1.5, Microsoft name: EmfPlusSetClipRegion Record,
   Index 0x34

        flags (LITTLE endian here, manual uses BIG endian)
           bits 12-15  CombineMode enumeration
           bits 0-7    Index of an U_PMF_REGION object in the EMF+ object table
   (0-63, inclusive)
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
...
/**  @brief EMF+ manual 2.3.2.1, Microsoft name: EmfPlusComment Record, Index
   0x03

          variable part of record, not included in structure
            char                data[];             //!< Private data, may be
   anything
*/
typedef struct {
...
/**  @brief EMF+ manual 2.3.3.1, Microsoft name: EmfPlusEndOfFile Record, Index
 * 0x02 */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
} U_PMF_ENDOFFILE;
...
/**  @brief EMF+ manual 2.3.3.3, Microsoft name: EmfPlusHeader Record, Index
   0x01
...
typedef struct {
    ...
    uint32_t EmfPlusFlags; //!< Reference device 0 bit: set = video device,
                           //! clear= printer.  Ignore all other bits.
...
/**  @brief EMF+ manual 2.3.4.2, Microsoft name: EmfPlusDrawArc Record, Index
   0x12

        flags (LITTLE endian here, manual uses BIG endian)
           bit  9      U_PPF_C Set: Rect is U_PMF_RECT; Clear: Rect is
   U_PMF_RECTF
           bits 0-7    Index of an U_PMF_PEN object in the EMF+ object table
   (0-63, inclusive)
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
    U_FLOAT Start;        //!< Start angle, >=0.0, degrees clockwise from 3:00
    U_FLOAT Sweep; //!< Sweep angle, -360<= angle <=360, degrees clockwise from
                   //! Start
                   /*  variable part of record, not included in structure
                       U_RECT or U_RECTF     Rect;             //!< Bounding box for elliptical
                      arc being drawn.
                   */
} U_PMF_DRAWARC;

/**  @brief  EMF+ manual 2.3.4.3, Microsoft name: EmfPlusDrawBeziers Record,
   Index 0x19
        flags (LITTLE endian here, manual uses BIG endian)
           bit  9      U_PPF_C Set: int16_t coordinates; Clear: U_FLOAT
   coordinates (IGNORE if bit 4 is set)
           bit 12      U_PPF_P Set: Coordinates are relative; Clear: they are
   absolute
           bits 0-7    Index of an U_PMF_PEN object in the EMF+ object table
   (0-63, inclusive)
...
typedef struct {
    ...
    uint32_t Elements;    //!< Number of members in the Points array
                          /*
                            variable part of record, not included in structure
                              (varies)              Points;           //!< Points, for type see table
                            above
                          */
} U_PMF_DRAWBEZIERS;

/** @brief EMF+ manual 2.3.4.4, Microsoft name: EmfPlusDrawClosedCurve Record,
Index 0x17
...
/** @brief EMF+ manual 2.3.4.5, Microsoft name: EmfPlusDrawCurve Record, Index
0x18
        flags (LITTLE endian here, manual uses BIG endian)
           bit  9      U_PPF_C Set: int16_t coordinates; Clear: U_FLOAT
coordinates (IGNORE if bit 4 is set)
...
/** @brief EMF+ manual 2.3.4.6, Microsoft name: EmfPlusDrawDriverString Record,
Index 0x36

        flags (LITTLE endian here, manual uses BIG endian)
.          bit 15      U_PPF_B Set: BrushID is an U_PFM_ARGB; Clear: is index of
U_PMF_BRUSH object in EMF+ object table
           bits 0-7    Index of an U_PMF_FONT object in the EMF+ object table
(0-63, inclusive)
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
    ...
    uint32_t HasMatrix; //!< If 1 record contains a TransformMatrix field, if 0
                        //! it does not.
    uint32_t Elements;  //!< Number of members in Glyphs and Positions array
                        /*
                          variable part of record, not included in structure
                            uint16_t              Glyphs;           //!< If U_DSO_CmapLookup is set
                          in DSOFlags this is an array
                                                                         of UTF16LE characters,
                          otherwise, it is an array of indices into the U_PMF_FONT
                                                                         object indexed by Object_ID
                          in flags.
                            U_PMF_POINTF          Positions;        //!< Coordinates of each member
                          of Glyphs.  U_DSO_RealizedAdvance set in DSOFlags
                                                                         Relative then positions are
                          calculated relative to the first glyph which is stored
                                                                         in Positions, otherwise,
                          all glyph positions are stored in Positions.
                            U_PMF_TRANSFORMMATRIX  Matrix;          //!< Transformation to apply to
                          Glyphs & Positions. Present if HasMatrix is 1
                        */
} U_PMF_DRAWDRIVERSTRING;

/** @brief EMF+ manual 2.3.4.7, Microsoft name: EmfPlusDrawEllipse Record, Index
   0x0F
...
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
                          /*
                            variable part of record, not included in structure
                              (varies)              Rect;             //!< Bounding rectangle, data
                            type set by bit1 of Header.Flags
                          */
} U_PMF_DRAWELLIPSE;

/** @brief EMF+ manual 2.3.4.8, Microsoft name: EmfPlusDrawImage Record, Index
   0x1A

        flags (LITTLE endian here, manual uses BIG endian)
           bit  9      U_PPF_C Set: DstRect is U_PMF_RECT; Clear: DstRect is
   U_PMF_RECTF
           bits 0-7    Index of an U_PMF_Image object in the EMF+ object table
   (0-63, inclusive)
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
    ...
    U_PMF_RECTF SrcRect;  //!< Region of image
                          /*
                            variable part of record, not included in structure
                              (varies)              DstRect;          //!< Destination rectangle for
                            image.  Type controlled by bit1 of Header.Flags
                          */
} U_PMF_DRAWIMAGE;

/** @brief EMF+ manual 2.3.4.9, Microsoft name: EmfPlusDrawImagePoints Record,
   Index 0x1B

        flags (LITTLE endian here, manual uses BIG endian)
           bit 14      U_PPF_C Set: Points is U_PMF_POINT; Clear: Points is
   U_PMF_POINTF
           bit 13      U_PPF_E Set: effect from previous
   U_PMF_SERIALIZABLEOBJECT record will be applied; Clear: no effect applied
           bit 11      U_PPF_P Set: Points has relative coordinates; Clear:
   Points has absolute coordinates
           bits 0-7    Index of an U_PMF_Image object in the EMF+ object table
   (0-63, inclusive)
...
typedef struct {
    ...
    uint32_t Elements;    //!< Number of members in Points, must be 3
                          /*
                            variable part of record, not included in structure
                              (varies)              Points;           //!< 3 points of a
                            parallelogram.  Type from bit1 and bit4 of Header.Flags, see table above
                          */
} U_PMF_DRAWIMAGEPOINTS;

/** @brief EMF+ manual 2.3.4.10, Microsoft name: EmfPlusDrawLines Record, Index
   0x0D

        flags (LITTLE endian here, manual uses BIG endian)
           bit  9      U_PPF_C Set: Points is U_PMF_POINT; Clear: Points is
   U_PMF_POINTF
           bit 10      U_PPF_D Set: close shape by connecting last point to
   first; Clear: leave path open
           bit 12      U_PPF_P Set: Points has relative coordinates; Clear:
   Points has absolute coordinates
           bits 0-7    Index of an U_PMF_Image object in the EMF+ object table
   (0-63, inclusive)
...
typedef struct {
    ...
    uint32_t Elements;    //!< Number of members in Points
                          /*
                            variable part of record, not included in structure
                              (varies)              Points;           //!< Sequence of points to
                            connect with line segments.  Type from bit1 and bit4 of Header.Flags, see
                            table above
                          */
} U_PMF_DRAWLINES;

/** @brief EMF+ manual 2.3.4.11, Microsoft name: EmfPlusDrawPath Record, Index
   0x15

        flags (LITTLE endian here, manual uses BIG endian)
           bits 0-7    Index of an U_PMF_PATH object in the EMF+ object table
   (0-63, inclusive)
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
...
/** @brief EMF+ manual 2.3.4.12, Microsoft name: EmfPlusDrawPie Record, Index
   0x0D
...
typedef struct {
    ...
    U_FLOAT Sweep; //!< Sweep angle, -360<= angle <=360, degrees clockwise from
                   ...
                   /*
                     variable part of record, not included in structure
                       U_RECT or U_RECTF     Rect;             //!< Bounding box for elliptical
                     pie segment being drawn.  Type from bit1 of Header.Flags, see above
                   */
} U_PMF_DRAWPIE;

/** @brief EMF+ manual 2.3.4.13, Microsoft name: EmfPlusDrawRects Record, Index
   0x0B
...
typedef struct {
    ...
    uint32_t Elements;    //!< Number of members in Rects
                          /*
                            variable part of record, not included in structure
                              U_RECT or U_RECTF     Rects;            //!< Array of rectangles to
                            draw.  Type from bit1 of Header.Flags, see above
                          */
} U_PMF_DRAWRECTS;

/** @brief EMF+ manual 2.3.4.14, Microsoft name: EmfPlusDrawString Record, Index
   0x1C
...
typedef struct {
    ...
    U_PMF_RECTF Rect;  //!< String's bounding box.
                       /*
                         variable part of record, not included in structure
                           uint16_t              String;           //!< Array of UFT-16LE unicode
                         characters.
                       */
} U_PMF_DRAWSTRING;

/** @brief EMF+ manual 2.3.4.15, Microsoft name: EmfPlusFillClosedCurve Record,
   Index 0x16
...
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
    uint32_t BrushID;     //!< Color or index to Brush object, depends on
                          //! Header.Flags bit0
    U_FLOAT Tension;   //!< Controls splines, 0 is straight line, >0 is curved
    uint32_t Elements; //!< Number of members in Points
                       /*
                         variable part of record, not included in structure
                           (varies)              Points;           //!< Sequence of points to
                         connect.  Type from bit1 and bit4 of Header.Flags, see table above
                       */
} U_PMF_FILLCLOSEDCURVE;

/** @brief EMF+ manual 2.3.4.16, Microsoft name: EmfPlusFillEllipse Record,
   Index 0x0E
...
/** @brief EMF+ manual 2.3.4.17, Microsoft name: EmfPlusFillPath Record, Index
0x14
Note: U_PMF_FILLPATHOBJ is the object, U_PMF_FILLPATH is the file record
...
/** @brief EMF+ manual 2.3.4.18, Microsoft name: EmfPlusFillPie Record, Index
   0x10
...
typedef struct {
    ...
    U_FLOAT Sweep; //!< Sweep angle, -360<= angle <=360, degrees clockwise from
                   ...
                   /*
                     variable part of record, not included in structure
                       U_RECT or U_RECTF     Rect;             //!< Bounding box for elliptical
                     pie segment being filled.  Type from bit1 of Header.Flags, see above
                   */
} U_PMF_FILLPIE;

/** @brief EMF+ manual 2.3.4.19, Microsoft name: EmfPlusFillPolygon Record,
   Index 0x0C
...
/** @brief EMF+ manual 2.3.4.20, Microsoft name: EmfPlusFillRects Record, Index
   0x0A
...
/** @brief EMF+ manual 2.3.4.21, Microsoft name: EmfPlusFillRegion Record, Index
   0x13
...
/** @brief EMF+ manual 2.3.5.1, Microsoft name: EmfPlusObject Record, Index 0x13
        ...
        flags (LITTLE endian here, manual uses BIG endian)
           bit  15      U_PPF_N Set: object definition continues in next record;
   Clear: this is the final object definition record
...
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
                          /*
                            variable part of record, not included in structure
                              uint8_t               Data;             //!< Object's data.  Type from
                            bits1-7 and bits8-15 of Header.Flags, see above
                          */
} U_PMF_OBJECT;

/** @brief EMF+ manual 2.3.5.2, Microsoft name: EmfPlusSerializableObject
   Record, Index 0x38
...
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
    uint8_t GUID[16];     //!< ImageEffects identifier. Composed of
                          //! Data1[4]-Data2[2]-Data3[2]-Data4[8]
    //!< Data1-Data3 are stored as little endian integers.  Data4 is stored big
    //! endian (like a string)
    uint32_t Size; //!< Bytes in Data.
                   /*
                     variable part of record, not included in structure
                       uint8_t               Data;             //!< "Serialized image effects
                     parameter block".  One of the ImageEffects objects.
                   */
} U_PMF_SERIALIZABLEOBJECT;

/** @brief EMF+ manual 2.3.6.1, Microsoft name: EmfPlusSetAntiAliasMode Record,
   Index 0x1E
...
/** @brief EMF+ manual 2.3.6.2, Microsoft name: EmfPlusSetCompositingMode
   Record, Index 0x23
...
/** @brief EMF+ manual 2.3.6.3, Microsoft name: EmfPlusSetCompositingQuality
   Record, Index 0x24
...
/** @brief EMF+ manual 2.3.6.4, Microsoft name: EmfPlusSetInterpolationMode
   Record, Index 0x21
...
/** @brief EMF+ manual 2.3.6.6, Microsoft name: EmfPlusSetRenderingOrigin
 * Record, Index 0x1D */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
...
/** @brief EMF+ manual 2.3.6.7, Microsoft name: EmfPlusSetTextContrast Record,
   Index 0x20

        flags (LITTLE endian here, manual uses BIG endian)
           bits 12-0   1000 x Gamma correction value.  Range 1000-2200 = gamma
   1.0-2.2
*/
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
...
/** @brief EMF+ manual 2.3.6.8, Microsoft name: EmfPlusSetTextRenderingHint
   Record, Index 0x1F
...
/** @brief EMF+ manual 2.3.7.1, Microsoft name: EmfPlusBeginContainer Record,
   Index 0x27
...
/** @brief EMF+ manual 2.3.7.2, Microsoft name: EmfPlusBeginContainerNoParams
 * Record, Index 0x28 */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
    uint32_t Index;       //!< Index to apply to this graphics container
...
/** @brief EMF+ manual 2.3.7.3, Microsoft name: EmfPlusEndContainer Record,
 * Index 0x29 */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
    uint32_t Index;       //!< Index of container being closed, from
    //! U_PMF_BEGINCONTAINERNOPARAMS or U_PMF_BEGINCONTAINER
} U_PMF_ENDCONTAINER;

/** @brief EMF+ manual 2.3.7.4, Microsoft name: EmfPlusRestore Record, Index
 * 0x26 */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
...
/** @brief EMF+ manual 2.3.8.1, Microsoft name: EmfPlusSetTSClip Record, Index
   0x3A

        flags (LITTLE endian here, manual uses BIG endian)
           bit 15      U_PPF_K Set: Rect is U_PMF_RECT; Clear: Rect is
   U_PMF_RECTF
...
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header
                          /*
                            variable part of record, not included in structure
                              U_RECT or U_RECTF     Rects;            //!< Array of rectangles to
                            draw.  Type from bit0 of Header.Flags, see above
                          */
} U_PMF_SETTSCLIP;

/** @brief EMF+ manual 2.3.8.2, Microsoft name: EmfPlusSetTSGraphics Record,
   Index 0x39

        flags (LITTLE endian here, manual uses BIG endian)
           bit   1     U_PPF_VGA Set: Palette is VGA basic colors; Clear:
   Palette is a U_PMF_PALETTE object.
           bit   0     U_PPF_PP Set: Palette field is present; Clear: Palette
   field is absent
*/
typedef struct {
    U_PMF_CMN_HDR Header;       //!< Common header
    ...
    U_PMF_TRANSFORMMATRIX WorldToDevice; //!< world to device transform
                                         /*
                                           optional part of record, not included in structure
                                             U_PMF_PALETTE         Palette;            //!< Present if bit15 of
                                           Header.Flags is set
                                         */
} U_PMF_SETTSGRAPHICS;

/** @brief EMF+ manual 2.3.9.1, Microsoft name: EmfPlusMultiplyWorldTransform
   Record, Index 0x2C
...
/** @brief EMF+ manual 2.3.9.2, Microsoft name: EmfPlusResetWorldTransform
Record, Index 0x2B
...
/** @brief EMF+ manual 2.3.9.3, Microsoft name: EmfPlusRotateWorldTransform
   Record, Index 0x2F
        Construct transformation matrix from Angle:
          sin(Angle)  cos(Angle) 0
          cos(Angle) -sin(Angle) 0
        Multiply this against current world space transform, result becomes new
...
/** @brief EMF+ manual 2.3.9.4, Microsoft name: EmfPlusScaleWorldTransform
   Record, Index 0x2E
...
/** @brief EMF+ manual 2.3.9.5, Microsoft name: EmfPlusSetPageTransform Record,
   Index 0x30
        flags (LITTLE endian here, manual uses BIG endian)
...
/** @brief EMF+ manual 2.3.9.6, Microsoft name: EmfPlusSetWorldTransform Record,
 * Index 0x2A */
typedef struct {
    U_PMF_CMN_HDR Header; //!< Common header  (ignore flags and set to zero)
    U_PMF_TRANSFORMMATRIX Matrix; //!< Transformation matrix
...
/** @brief EMF+ manual 2.3.9.7, Microsoft name: EmfPlusTranslateWorldTransform
   Record, Index 0x2D
        Construct transformation matrix:
          1  0  Dx
          0  1  Dy
...
U_PSEUDO_OBJ *U_PMF_PATHPOINTTYPE_set2(uint32_t Elements, uint8_t Start,
                                       uint8_t Others);
...
U_PSEUDO_OBJ *U_PMR_OBJECT_set(uint32_t ObjID, int otype, int ntype,
                               uint32_t TSize, size_t cbData, const char *Data);
...
U_PSEUDO_OBJ *U_PMR_BEGINCONTAINER_set(int UTenum, U_PSEUDO_OBJ *DstRect,
                                       U_PSEUDO_OBJ *SrcRect, uint32_t StackID);
...
int U_PMF_PEN_get(const char *contents, uint32_t *Version, uint32_t *Type,
                  const char **PenData, const char **Brush, const char *blimit);
...
int U_PMF_PENOPTIONALDATA_get(
    const char *contents, uint32_t Flags, U_PMF_TRANSFORMMATRIX *Matrix,
    int32_t *StartCap, int32_t *EndCap, uint32_t *Join, U_FLOAT *MiterLimit,
    int32_t *Style, int32_t *DLCap, U_FLOAT *DLOffset, const char **DLData,
    int32_t *Alignment, const char **CmpndLineData, const char **CSCapData,
    const char **CECapData, const char *blimit);
